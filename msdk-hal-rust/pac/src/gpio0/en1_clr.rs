...
pub type R = crate::R<EN1_CLR_SPEC>;
#[doc = "Register `EN1_CLR` writer"]
pub type W = crate::W<EN1_CLR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn all(&mut self) -> ALL_W<EN1_CLR_SPEC> {
        ALL_W::new(self, 0)
    }
...
#[doc = "GPIO Alternate Function Clear. Writing a 1 to one or more bits in this register clears the bits in the same positions in GPIO_EN1 to 0, without affecting other bits in that register.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`en1_clr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`en1_clr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EN1_CLR_SPEC;
impl crate::RegisterSpec for EN1_CLR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`en1_clr::R`](R) reader structure"]
impl crate::Readable for EN1_CLR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`en1_clr::W`](W) writer structure"]
impl crate::Writable for EN1_CLR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets EN1_CLR to value 0"]
impl crate::Resettable for EN1_CLR_SPEC {
