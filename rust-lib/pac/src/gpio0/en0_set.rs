...
pub type R = crate::R<EN0_SET_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn all(&mut self) -> ALL_W<EN0_SET_SPEC> {
        ALL_W::new(self, 0)
    }
