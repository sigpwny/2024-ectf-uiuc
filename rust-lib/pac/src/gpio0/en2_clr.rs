...
pub type R = crate::R<EN2_CLR_SPEC>;
#[doc = "Register `EN2_CLR` writer"]
pub type W = crate::W<EN2_CLR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn all(&mut self) -> ALL_W<EN2_CLR_SPEC> {
        ALL_W::new(self, 0)
    }
