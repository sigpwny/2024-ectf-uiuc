...
pub type R = crate::R<OUTEN_SET_SPEC>;
#[doc = "Register `OUTEN_SET` writer"]
pub type W = crate::W<OUTEN_SET_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn all(&mut self) -> ALL_W<OUTEN_SET_SPEC> {
        ALL_W::new(self, 0)
    }
...
#[doc = "GPIO Output Enable Set Function Enable Register. Writing a 1 to one or more bits in this register sets the bits in the same positions in GPIO_OUT_EN to 1, without affecting other bits in that register.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`outen_set::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`outen_set::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OUTEN_SET_SPEC;
impl crate::RegisterSpec for OUTEN_SET_SPEC {
    type Ux = u32;
}
